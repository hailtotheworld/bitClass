						 	...
						 	<c:set var="checked" value="checked"/>
								...
								<tr>
									...
									<td class="title indent text-align-left"><a
										href="/JspClonePrj2/admin/notice/detail?id=${n.id}">${empty n.title?"제목없음":n.title}</a> <span>[${n.cmtCount}]</span></td>
									<td>${n.writerId}</td>
									<td>${n.regdate}</td>
									<td>${n.hit}</td>
									<td><input type="checkbox" name="open" ${checked} value="${n.id}"></td>
