...
$(document).ready(function(){
    ...
    var userId = $('#userId'); // var userId = document.querySelector('#userId');
    var pw = $('#pw'); //var pw = document.querySelector('#pw');
    var repw = $('repw'); // var repw = document.querySelector('#repw');
    var userName = $('userName'); // var userName = document.querySelector('#userName');

    // 이벤트 설정 : 입력
    // 2021.12.02 jquery 이벤트로 변경
    ...
    var editForm = $('#editForm'); // var editForm = document.querySelector('#editForm');
    var index = $('#index'); // var index = document.querySelector('#index');
    //var eid = document.querySelector('#eid');
    var epw = $('#epw');// var epw = document.querySelector('#epw');
    var erepw = $('#erepw'); // var erepw = document.querySelector('#erepw');
    var ename = $('ename');// var ename = document.querySelector('#ename');
    var resetBtn =$('#resetBtn'); // var resetBtn = document.querySelector('#resetBtn');
